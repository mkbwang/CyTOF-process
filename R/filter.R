...
#' Apply filtering on a single FCS flowframe
#'
#' @param cytoframe
#' A flowframe object defined in package 'flowCore'.
#'
#' @return
#' A data table object of a subset of the original flowframe expression matrix.
#'
#' @importFrom flowCore identifier exprs
#' @import data.table
#' @importFrom stats sd
#'
